...
class CreateScreamRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(
            f"CreateScreamRequest representation: "
            f"user_id={self.user_id[:5]}..."
        )
...
class CreateAdminRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(
            f"CreateAdminRequest representation: "
            f"user_id={self.user_id[:5]}..., "
            f"to_admin={self.user_id_to_admin[:5]}..."
        )
        return (
            f"<CreateAdminRequest(from={self.user_id[:5]}..., "
            f"to={self.user_id_to_admin[:5]}...)>"
        )
...
class GetIdRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(f"GetIdRequest representation: "
                     f"user_id={self.user_id[:5]}...")
...
class ReactionRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(
            f"ReactionRequest representation: user_id={self.user_id[:5]}..., "
            f"scream_id={self.scream_id}"
        )
        return (
            f"<ReactionRequest(user={self.user_id[:5]}..., "
            f"scream={self.scream_id}, emoji={self.emoji})>"
        )
...
class DeleteRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(
            f"DeleteRequest representation: user_id={self.user_id[:5]}..., "
            f"scream_id={self.scream_id}"
        )
        return (
            f"<DeleteRequest(user={self.user_id[:5]}..., "
            f"scream={self.scream_id})>"
        )
...
class UserRequest(BaseModel):
    ...
    def __repr__(self):
        logger.debug(f"UserRequest representation: "
                     f"user_id={self.user_id[:5]}...")
