...
async def get_session() -> AsyncGenerator[AsyncSession, None]:
    ...
    Behavior:
        ...
        - Catches and logs any errors during session creation or teardown, then propagates them.

    Raises:
        Exception: Re-raises any exception encountered while instantiating or closing the session.
    """
    try:
